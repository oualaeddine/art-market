...
@section('content')
    ...
    @include('ProductsUi::modals.restore')
        ...
        <script>
            $(document).ready(function() {
                ...
                $('#products_table').DataTable({
                    ...
                    ajax: {
                        url: '{{route('admin.products.archived')}}',
                    },
                    columns: [{
                            data: 'responsive',
            ...
            function RestoreProduct(id) {
                ...
                var url_change_delete_form = "{{ route('admin.products.restore', ':id') }}";

                url_change_delete_form = url_change_delete_form.replace(':id', id);

                $('#form-restore-product').attr('action', url_change_delete_form);
