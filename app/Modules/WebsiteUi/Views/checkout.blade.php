                        ...
                        <form>
                            <div class="billing__form">
                                <div class="billing__list">
                                    <div class="billing__item">
                                        <div class="d-lg-flex justify-content-between align-items-center">
                                            ...
                                            @guest('client')
                                                <a class="button description__button mt-lg-0 mt-3" href="{{route('client.login')}}">{{__("Do you have an account?")}}</a>
                                            ...
                                            <div class="row justify-content-start">
                                                <div class="col-md-6">
                                                    <div class="field field field__style__one">
                                                        ...
                                                        <div class="field__wrap">
                                                            <input class="field__input" type="text" name="last_name" value="{{auth()->guard('client')->check()?auth()->guard('client')->user()->last_name:''}}" placeholder="{{__("Last name")}}" required="" />
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="field field__style__one">
                                                        ...
                                                        <div class="field__wrap">
                                                            <input class="field__input" type="text" name="first_name" value="{{auth()->guard('client')->check()?auth()->guard('client')->user()->first_name:''}}" placeholder="{{__("First name")}}" required="" />
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row justify-content-start">
                                                <div class="col-md-7">
                                                    <div class="field field field__style__one">
                                                        ...
                                                        <div class="field__wrap">
                                                            <input class="field__input" type="tel" value="{{auth()->guard('client')->check()?('0'.auth()->guard('client')->user()->phone):''}}" name="phone" placeholder="" required="" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="row justify-content-start">
                                                    <div class="col-md-10">
                                                        <div class="field field field__style__one select__field">
                                                            ...
                                                            <div class="field__wrap">
                                                                <select class="select" name="address" required>
                                                                    <option value="" selected disabled>{{__("Select your address")}}</option>
                                ...
                                @guest('client')
                                    <div class="billing__list">
                                        <div class="billing__item">
                                            <div class="billing__category">Shipping informations <small class="d-block">collection tracked & signed</small></div>
                                            <div class="billing__fieldset">
                                                <div class="row justify-content-start">
                                                    <div class="col-md-5">
                                                        <div class="field field field__style__one select__field">
                                                            ...
                                                            <div class="field__wrap">
                                                                <input class="field__input" type="text" name="item" placeholder="{{__("Wilaya")}}" required="" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-5">
                                                        <div class="field field__style__one select__field">
                                                            ...
                                                            <div class="field__wrap">
                                                                <input class="field__input" type="text" name="item" placeholder="{{__("Commune")}}" required="" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row justify-content-start">
                                                    <div class="col-md-12">
                                                        <div class="field field__style__one">
                                                            ...
                                                            <div class="field__wrap">
                                                                <input class="field__input" type="text" name="item" placeholder="{{__("Address")}}" required="" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                    ...
                    <div id="sticky-sidebar" class="col-lg-4 col-12 mt-lg-0 mt-10 pl-lg-0">
                        <div class="cart__filters js-activity-filters sidebar__inner">
                            ...
                            <div class="popup__btns">
                                <button class="button popup__button">PROCEED TO CHECKOUT</button>
                            </div>
                        </div>
                    </div>
                </div>
