...
//    Route::get('/compare', ShowCompare::class)->name('compare');
    Route::get('/produit/{slug}', ShowProductPage::class)->name('product');
...
Route::group(['prefix' => 'ar', 'as' => 'rtl.' , 'middleware' => ['ChangeLang'] ], function () {
