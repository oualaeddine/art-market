...
@section('content')
    ...
    @include('ClientsUi::modals.contact.restore')
        ...
        <script>
            ...
            $(document).ready(function () {
                ...
                $('#contacts_table').DataTable({
                    ...
                    ajax:{
                        url : '{{route('admin.contacts.archived')}}',
                        cache: false
                    },
                    columns: [
            ...
            function RestoreContact(id){
                ...
                var url_change_delete_form = '{{ route("admin.contacts.restore",":contact") }}';

                url_change_delete_form = url_change_delete_form.replace(':contact', id);

                $('#form-restore-contact').attr('action', url_change_delete_form);
