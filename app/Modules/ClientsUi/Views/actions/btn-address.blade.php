...
<a href="javascript:;" data-bs-placement="top" title="modifier" data-bs-toggle="modal"
   data-bs-target="#modals-edit-client-address" onclick="EditAddress({{$address->id}})"><i
...
<a href="javascript:;" data-bs-placement="top" title="supprimer" data-bs-toggle="modal"
   data-bs-target="#modals-delete-client-address" onclick="DeleteAddress({{$address->id}})"><i
        class="fa fa-archive f-w-600 f-20 text-c-red"></i>
</a>


{{--    <a href="javascript:;" class="item-edit text-info waves-effect" data-bs-placement="top" title="modifier" data-bs-toggle="modal"--}}
{{--    data-bs-target="#modals-edit-client-address" onclick="EditAddress({{$address->id}})">--}}
...
{{--    data-bs-target="#modals-delete-client-address" onclick="DeleteAddress({{$address->id}})">--}}
{{--    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"--}}
{{--       viewBox="0 0 24 24" fill="none" stroke="currentColor"--}}
