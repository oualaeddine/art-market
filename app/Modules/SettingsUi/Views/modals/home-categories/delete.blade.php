<div class="modal fade" id="modals-delete-home-offer-prod" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="" id="form-delete-home-offer-prod" method="POST">
                @csrf
                @method('delete')
            <div class="modal-header">
                <h4 class="modal-title text-danger">Supprimer une catégorie</h4>
