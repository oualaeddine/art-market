<div class="modal fade" id="modal-add_cat" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <form class="add-new-record modal-content pt-0" id="form-add_cat"
                  action=""
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input  required value="{{old('name_fr')}}" type="text" class="form-control" id="name_fr" name="name_fr"
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input required  dir="rtl" value="{{old('name_ar')}}" type="text" class="form-control" id="name_ar" name="name_ar"
                                    placeholder="الاسم">
                            <span class="messages"></span>
                        </div>
                    </div>
