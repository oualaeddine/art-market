...
@section('content')
    ...
    <div class="card">
        ...
        <form class="pt-0" action="{{route('admin.website-images.update',$images->id)}}" method="POST"
            ...
            <div class="card-block">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-12 col-md-4">
                        ...
                        <input type="text" readonly name="lang" value="{{$images->lang}}" class="form-control mt-1"
                               id="">
                    </div>
