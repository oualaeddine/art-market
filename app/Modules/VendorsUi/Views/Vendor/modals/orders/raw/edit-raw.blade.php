...
<div class="modal fade" id="modals-slide-in-product-edit-raw" tabindex="-1" role="dialog">
    <div class="modal-dialog " role="document">
        <div class="modal-content">
            <form class="add-new-record modal-content pt-0" id="form-edit-order-raw" action=""
                  method="POST">
                @csrf
                @method('put')
