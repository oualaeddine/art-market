        ...
        <script>
            ...
            $(document).ready(function () {
                ...
                $('#add-product').on('click',function(){
                    ...
                    var url= '{{route('vendor.orders.get.products',"vendor_id=")}}';
                    url =url.replace('vendor_id=', '{{'vendor_id='.auth()->guard('vendor')->user()->vendor_id}}');
            ...
            $('#client_id').select2({
                ...
                $('#client_id').on('change',function(){
                        ...
                        var url_update = '{{ route("vendor.orders.get.info",":id") }}';
            ...
            function get_commune(id){
                 ...
                 var id = id;
                    ...
                    var url_coumne = '{{ route("vendor.orders.get.commune",":id") }}';
