...
@section('content')
    ...
    <div class="card">
        <form class="add-new-record modal-content pt-0"  action="{{route('vendor.users.update',['user'=>$user->id])}}"
              method="POST">
            @csrf
            @method('PUT')
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12 col-md-4">
                            ...
                            <select required name="is_active" class="form-control" id="">
                                <option {{$user->is_active?'selected':''}} value="1">Actif</option>
                                <option {{$user->is_active?'':'selected'}}  value="0">Non actif</option>
                            </select>
                        </div>
