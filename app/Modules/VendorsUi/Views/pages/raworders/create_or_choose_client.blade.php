...
@section('content')
    ...
    @include('OrdersUi::modals.delete-raw-upgrade')
    @include('OrdersUi::modals.add-raw-upgrade')

    <form action="{{route('admin.vendors.orders.raw.upgrade',['order'=>$order->id])}}">
        <div class="row">
            <div class="col-sm-12 col-xl-3 col-md-4">
    ...
    @push('js')
        ...
        <script>
            ...
            function deleteRawProduct(id) {
                ...
                var url_change_delete_form = '{{ route("admin.orders.raw.upgrade.product-delete",":order_product") }}';
            ...
            $(document).ready(function () {
                ...
                $('#client_id').select2({
                    ...
                    ajax: {
                        url: '{{route('admin.orders.raw.get.clients')}}',
                        dataType: 'json',
                ...
                $('#product_id').select2({
                    ...
                    minimumInputLength: 4,
                    ajax: {
                        url: '{{route('admin.orders.raw.get.products')}}',
                        dataType: 'json',
                        // Additional AJAX parameters go here; see the end of this chapter for the full code of this example
                        processResults: function (data) {
                            return {
