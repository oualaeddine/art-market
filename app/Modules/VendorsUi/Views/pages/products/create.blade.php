...
@section('content')
    ...
    <div class="card">
        ...
        <form class="pt-0" action="{{route('admin.vendors.products.store',['vendor'=>$vendor->id])}}" method="POST" enctype="multipart/form-data">
                @csrf
...
{{--                 <div class="form-group col-md-3">--}}
{{--                     <label class="form-label" for="family_edit">Actif</label> <b class="text-danger">*</b>--}}
