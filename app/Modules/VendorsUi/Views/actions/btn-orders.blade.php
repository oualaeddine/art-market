    ...
    <a  href="{{route('admin.vendors.orders.details',$id)}}" class="item-edit text-success waves-effect" data-bs-placement="top" title="détail">
     <i class="fa fa-eye"></i>
   </a>

    @if($status!=='completed')
    <a  href="javascript:;" class="item-edit text-info waves-effect" id="edit-order{{$id}}" data-bs-toggle="modal"
