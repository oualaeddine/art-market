...
@section('content')
    ...
    @include('VendorsUi::modals.delete')
    @include('VendorsUi::modals.toggle')
    ...
    @push('js')
        ...
        <script>
            ...
            function ToggleVendor(id){
                ...
                var url_change_delete_form = '{{ route("admin.vendors.toggle",":vendor") }}';

                url_change_delete_form  =  url_change_delete_form .replace(':vendor', id);

                $('#form-toggle-vendor').attr('action',url_change_delete_form );
                ...
                var url_change_delete_form = '{{ route("admin.vendors.delete",":vendor") }}';

                url_change_delete_form  =  url_change_delete_form .replace(':vendor', id);

                $('#form-delete-vendor').attr('action',url_change_delete_form );
