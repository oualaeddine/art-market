...
class StoreProduct
{
    ...
    public function handle(ActionRequest $request): Product
    {
        ...
        return Product::create($this->getProductFields($request) + ['is_active'=>true,'vendor_id' => auth()->guard('vendor')->user()->vendor_id, 'image' => $path, 'rating' => $random_rat]);
