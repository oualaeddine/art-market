...
class ShowUpgradeToOrderVendor
{
    use AsAction;
    ...
    public function asController(Request $request,RawOrder $order)
    {
        ...
        return view('VendorsUi::pages.raworders.create_or_choose_client', compact('client_commune','client_wilaya','client','order','header', 'user_info','breadcrumbs','wilayas'))->with(['page_title' => "Attribuer la commande"]);
    }
