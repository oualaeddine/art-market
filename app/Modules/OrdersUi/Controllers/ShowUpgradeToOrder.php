...
class ShowUpgradeToOrder
{
    ...
    public function asController(Request $request,RawOrder $order)
    {
        ...
        return view('OrdersUi::create_or_choose_client', compact('client_commune','client_wilaya','client','order','header', 'user_info','breadcrumbs','wilayas'))->with(['page_title' => "Attribuer la commande"]);
    }
