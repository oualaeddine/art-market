...
namespace App\Modules\OrdersUi\Controllers\Coupons;
...
//            $url   = 'http://127.0.0.1:8001/api/V1/get/families';
        ...
        return view('OrdersUi::coupon-generation', compact('header', 'user_info','breadcrumbs','families','order'))->with(['page_title' => "Commandes"]);
