<div class="modal fade" id="archive-order_raw" tabindex="-1" role="dialog">
        ...
        <div class="modal-content">
            <form action="" id="form-delete-order" method="POST">
                ...
                <div class="modal-header">
                    <h4 class="modal-title text-danger">Archiver une commande</h4>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <p>êtes-vous sûr de archiver cette commande ?</p>
                </div>
