...
<div class="popup popup_connect mfp-hide" id="DeleteOrderModal">
    <form action="" id="DeleteOrderForm" method="POST">
        ...
        <h5 class="h5 text-center">{{__("Delete order")}}</h5>
        ...
        <div class="popup__btns">
            <button class="button popup__button bg-red" type="submit">{{__("Delete order")}}</button>
