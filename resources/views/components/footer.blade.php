        ...
        <div class="container">
            <div class="row justify-content-start">
                <div class="col-md-3 col-12 text-lg-left text-center mb-lg-0 mb-10">
                    <a class="footer__logo" href="index.html"><img class="some-icon" src="website/images/logo-dark.png" alt="Crypter NFT" /><img class="some-icon-dark" src="website/images/logo-light.png" alt="Crypter NFT" /></a>
                    <div class="footer__info"><i class="fad fa-map-marked-alt"></i> 17 rue de setif, algeria.</div>
                    <div class="footer__info__contact"><a href="#">support@coodiv.net</a> <a href="#">003135566332</a></div>
                </div>
                ...
                <div class="col-md-3 col-12 text-lg-left text-center">
                    <div class="subscription__contanier__footer">
                        <div class="subscription__contanier__footer__header mb-10">
                            ...
                            <p class="sub-title">& be the first to know about new arrivals, special offers, in-store events and news.</p>
                        </div>
            ...
            <div class="footer__foot">
                ...
                <div class="footer__note">
                    <i class="fab fa-cc-amazon-pay"></i> <i class="fab fa-cc-amex"></i> <i class="fab fa-cc-discover"></i> <i class="fab fa-cc-stripe"></i> <i class="fab fa-cc-visa"></i> <i class="fab fa-cc-paypal"></i>
                    <i class="fab fa-cc-mastercard"></i> <i class="fab fa-cc-apple-pay"></i>
                </div>
            </div>
        </div>
    </footer>
