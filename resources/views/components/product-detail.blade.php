                    ...
                    <div class="item__preview">
                        ...
                        <div id="mainCarousel" class="item__preview__slider__items_group">
                            <div class="carousel__slide item__preview__slider__item"
                                ...
                                <img style="cursor: pointer;" src="{{asset($product->image??'https://toka.b-cdn.net/wp-content/uploads/2022/04/vrgvg.png')}}"/>
                            </div>
                          @foreach($product->images as $image)
                                <div class="carousel__slide item__preview__slider__item"
                                     data-src="{{asset($image->image??'https://toka.b-cdn.net/wp-content/uploads/2022/04/vrgvg.png')}}" data-fancybox="gallery">
                                    <img style="cursor: pointer;" src="{{asset($image->image??'https://toka.b-cdn.net/wp-content/uploads/2022/04/vrgvg.png')}}"/>
                                </div>
                          @endforeach
                        </div>
                        ...
                        <div id="thumbCarousel" class="mini__item__preview_buttom">
                            ...
                            <div class="carousel__slide">
                                <img style="cursor: pointer;" class="panzoom__content" src="{{asset($product->image??'https://toka.b-cdn.net/wp-content/uploads/2022/04/vrgvg.png')}}"/>
                            </div>
                            @foreach($product->images as $image)
                                <div class="carousel__slide">
                                    <img style="cursor: pointer;" class="panzoom__content" src="{{asset($image->image??'https://toka.b-cdn.net/wp-content/uploads/2022/04/vrgvg.png')}}"/>
                                </div>
                            @endforeach
                        </div>
                    </div>
...
{{--                    </div>--}}
            ...
            <div class="col-md-6">
                <div class="item__details item__page">
                    <h1 class="item__title h3">{{$product->{app()->getLocale()=='fr'?'name_fr':'name_ar'} }} <a class="item__title__user" href="{{route('vendor-detail',$product->vendor->name_fr)}}">{{__("by")}}&nbsp;:
...
{{--                    </div>--}}
                    ...
                    <div class="item__price align-items-center d-flex justify-content-start mb-10">
                        ...
                        <div class="the__price">{{number_format($product->price,2).' '.trans('DA')}} </div>
                    </div>
                        ...
                        <div class="item__container">
                            <div class="item__box js-tabs-item" style="display: block;">
                                <ul class="item__tabs__informations">
                                    ...
                                    <li><b>{{__("Categories")}} : </b> {{Arr::join($product->categories->pluck(app()->getLocale()=='fr'?'name_fr':'name_ar')->toArray(),', ',trans('and'))}}</li>
                                    <li><b>{{__("Brand")}} : </b> {{Arr::join($product->brands->pluck(app()->getLocale()=='fr'?'name_fr':'name_ar')->toArray(),', ',trans('and'))}} </li>
                                    <li><b>{{__("Shipping price")}} : </b> <span class="text-success">{{number_format($product->shipping,2).' '.trans('DA')}}</span> </li>
                                </ul>
{{--                                <div--}}
