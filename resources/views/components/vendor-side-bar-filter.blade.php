        ...
        <div class="sidebar__filter__shop_section__body mt-8">
            ...
            <ul class="sidebar__filter__shop_section__body__element__ul">
                @foreach($categories as $category)
                    <li>
                        <a href="javascript:void(0)" data-id="{{$category->name_fr}}" class="category-link  {{$selected_category==$category->name_fr?'bg-gray-3  p-1 rounded ':''}}"><span class="text">{{$category->{app()->getLocale()=='fr'?'name_fr':'name_ar'} }}</span> </a>
                    </li>
                @endforeach
            </ul>
            ...
            <ul class="sidebar__filter__shop_section__body__element__ul">
                @foreach($brands as $brand)
                    <li>
                        <a href="javascript:void(0)" data-id="{{$brand->name_fr}}" class="brand-link {{$selected_brand==$brand->name_fr?'bg-gray-3  p-1 rounded ':''}}" ><span class="text">{{$brand->{app()->getLocale()=='fr'?'name_fr':'name_ar'} }}</span></a>
                    </li>
                @endforeach
            </ul>
